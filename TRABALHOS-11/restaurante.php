...
<body>
    <div class="container">
		...
		if ($_SERVER["REQUEST_METHOD"] == "POST") {
			...
			echo "<h3>Resumo do Valor da conta</h3>";
			...
			if ($percentual_gorjeta == 0.10) {
				echo "percentual de gorjeta de 10%";
			} elseif ($percentual_gorjeta == 0.15) {
				echo "percentual de gorjeta de 15%";
			} elseif ($percentual_gorjeta == 0.20) {
				echo "percentual de gorjeta de 20%";
			}
			echo "</p>";
			echo "<p><strong>Valor da Gorjeta:</strong> R$ " . number_format($valor_gorjeta, 2, ',', '.') . "</p>";
